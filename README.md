...
This project is completed as part of DSCI 522 (Data Science workflows); a course in the Master of Data Science program at the University of British Columbia.
...
4. To reset the project to a clean state (i.e., remove all files generated by previous runs of the analysis), open a terminal in the Jupyter Lab enviornment and run the following commands:
```
make clean
```
