...
Raw dataset preview (static reference to the locally cached file).

: Raw Maternal Health Risk Data {#tbl-raw-data}

| Resource | Location |
| --- | --- |
| Raw dataset (CSV) | [../data/raw/Maternal Health Risk Data Set.csv](../data/raw/Maternal%20Health%20Risk%20Data%20Set.csv) |


Training split stored locally (no runtime execution required).

: Training Data Split {#tbl-train-data}

| Resource | Location |
| --- | --- |
| Training split CSV | [../data/processed/maternal_health_risk_train.csv](../data/processed/maternal_health_risk_train.csv) |

Testing split stored locally.

: Testing Data Split {#tbl-test-data}

| Resource | Location |
| --- | --- |
| Testing split CSV | [../data/processed/maternal_health_risk_test.csv](../data/processed/maternal_health_risk_test.csv) |

Class counts are available in the precomputed training split (no code execution needed during render).

: Risk Level Counts in Training Data {#tbl-risk-counts}

| Resource | Location |
| --- | --- |
| Training split with risk labels | [../data/processed/maternal_health_risk_train.csv](../data/processed/maternal_health_risk_train.csv) |
